...
export default function VideosPage() {
  ...
  async function removeVideo(video: StoredVideo) {
    if (!confirm(`Apagar definitivamente “${video.title}”? O vídeo, a VSL e seus arquivos de personalização não poderão ser recuperados.`)) return;
