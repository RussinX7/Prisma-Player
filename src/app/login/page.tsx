...
export default function LoginPage() {
  ...
  async function signInWith(provider: "google" | "apple") {
    ...
    } catch (oauthError) { setError(getAuthErrorMessage(oauthError, "Não foi possível abrir o provedor de acesso.")); }
  }
  ...
  async function recoverPassword() {
    ...
    try {
      ...
      setError(getAuthErrorMessage(recoverError, "Não foi possível enviar o e-mail."));
    }
  }
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-[420px] animate-fade-in">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button type="button" onClick={() => signInWith("google")} aria-disabled={!oauthEnabled("google")} className="h-[44px] flex items-center justify-center gap-2 themeable-bg-canvas border themeable-border-hairline rounded-pill text-caption themeable-text-ink transition-all hover:themeable-bg-canvas-parchment active:scale-[0.98] aria-disabled:opacity-40">
            ...
            <button type="button" onClick={() => signInWith("apple")} aria-disabled={!oauthEnabled("apple")} className="h-[44px] flex items-center justify-center gap-2 bg-surface-black text-white border border-surface-black rounded-pill text-caption transition-all hover:opacity-90 active:scale-[0.98] aria-disabled:opacity-40">
